    ...
    <el-card class="box-card">
      ...
      <div>
        <el-form>
          ...
          <el-form-item>
            <el-button type="primary" :round="true" @click="enc">编码</el-button>
            <el-button type="primary" :round="true" @click="dec">解码</el-button>
...
export default {
  ...
  methods: {
    enc() {
      ...
      const charset = _this.form.charset

      _this.form.result = encodeURIComponent(content)
    },
    dec() {
      console.log('dec')
      const _this = this
      ...
      _this.form.result = decodeURIComponent(content)
    },
    exchange() {
